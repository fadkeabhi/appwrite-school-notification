                ...
                <div className='grid text-white p-3 md:grid-cols-3 xl:grid-cols-4 gap-4 overflow-x-hidden overflow-y-auto'>
                {
                    studentsDetails.map((student)=>(
                        <div className='flex bg-[#394867] rounded-md'>
                            <div key={student.$id} className='flex-1 text-white text-lg font-semibold flex flex-col p-4 rounded-md'>
                                <p>{student.email}</p>
                            ...
                            <button
                             onClick={()=>{
                                navigate(`/admin/student/edit?id=${student.$id}&email=${student.email}`)
